...
class CreateImpressionsTable < ActiveRecord::Migration[4.2]
  ...
  def self.down
    ...
    add_index :impressions, [:impressionable_type, :impressionable_id, :request_hash, :ip_address],
              name: "poly_index", unique: false
    add_index :impressions, [:controller_name,:action_name,:request_hash,:ip_address],
