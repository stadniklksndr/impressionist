...
# the test environment when running specs.
ENV["RAILS_ENV"] ||= "test"

# Loads separate Rails environment (the dummy app)
# to test the gem’s integration with Rails.
require_relative "dummy/config/environment"

# Load rspec-rails gem to extends RSpec’s functionality
# which provides Rails-specific support for testing with RSpec
